...
const mockProducts = [
  {
    ...
    price: "NGN 120,000",
    imageUrl: "/solar-generator.jpg",
    rating: 4.8,
    reviews: 42,
    description: "Portable solar generator for backup power.",
    link: "/products/solar-generators",
  },
  {
    id: 2,
    name: "Streetlight",
    ...
    link: "/products/streetlights",
  },
  {
    id: 3,
    name: "Solar Charge Controller",
    price: "NGN 18,000",
    imageUrl: "/solar-charge-controller.jpg",
    rating: 4.7,
    reviews: 27,
    description: "Efficient charge controller for solar systems.",
    link: "/products/solar-charge-controllers",
  },
  {
    id: 4,
    name: "Solar Generator",
